/* rough.js v4.6.6 — biblioteca hand-drawn (a mesma do Excalidraw). Build IIFE bundled (expoe window.rough).
   Vendorizado offline-first (sem CDN, D-24), mesmo padrao do dagre. Fonte: roughjs@4.6.6 bundled/rough.js (npm).
   NAO editar manualmente — substituir baixando a versao bundled correspondente do npm. */
